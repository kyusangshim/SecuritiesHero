...
@Getter
@Builder
public class DartShortTermBondBalanceResponse {
     ...
     */
    public static DartShortTermBondBalanceResponse from(DartShortTermBondBalance entity) {
        return DartShortTermBondBalanceResponse.builder()
                ...
                .sm(entity.getSm())
                .isuLmt(entity.getIsuLmt())
                .remndrLmt(entity.getRemndrLmt())
